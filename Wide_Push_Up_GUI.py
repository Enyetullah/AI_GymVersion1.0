...
class VideoPlayer:
    def __init__(self, weight):
        ...
        self.exerciseName = "WIDE"  # Set the exercise name
        ...
        self.canvas.create_text(250, 50, text="For a demonstration on how to do a Wide Arm Push Up, Please watch "
                                              "the video \n"
        ...
        self.videoPath = r"D:\gym\Tutorial Videos\Wide Pushup tutorial, Benefits and Muscle worked.mp4"
    ...
    def realTime(self):
        ...
        Wide_Arm_Push_Up.WidePush(self.weight)  # Call the real-time exercise function with the weight

    # Handle video upload exercise button click
    def videoUpload(self):
        self.root.destroy()  # Close the current window
        Video_Upload_GUI.Upload(self.weight,
                                self.exerciseName)  # Call the video upload function with weight and exercise name
